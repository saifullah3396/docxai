...
class Bottle2neck(nn.Module):
    ...
    def __init__(
        ...
        for i in range(self.num_scales):
            ...
            act_layers.append(act_layer(inplace=False))
        ...
        self.relu1 = act_layer(inplace=False)
        self.relu2 = act_layer(inplace=False)
    ...
    def forward(self, x):
        ...
        for i, (conv, bn, act_layer) in enumerate(zip(self.convs, self.bns, self.act_layers)):
