...
from transformers.tokenization_utils_base import (BatchEncoding,
                                                  ...
                                                  TextInputPair,
                                                  TruncationStrategy)
from xai_torch.core.data.tokenizers.decorators import register_hf_tokenizer


@register_hf_tokenizer(reg_name="layoutlm_v2_custom")
@dataclass
class LayoutLMv2TokenizerFastCustom(LayoutLMv2TokenizerFast):
    registration_name = "layoutlm_v2_tokenizer_fast_custom"
