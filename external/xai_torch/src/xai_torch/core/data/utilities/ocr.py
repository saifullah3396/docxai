...
class TesseractOCRGraphReader(TesseractOCRReader):
    ...
    def add_edge(self, from_id, to_id):
        ...
        from_center = np.array(get_bbox_center(self._graph.nodes[from_id][DataKeys.WORD_BBOXES]))
        to_center = np.array(get_bbox_center(self._graph.nodes[to_id][DataKeys.WORD_BBOXES]))
