...
from xai_torch.core.training.sch.args import WDSchedulerArguments

if TYPE_CHECKING:
    import torch
    from xai_torch.core.training.sch.args import LRSchedulerArguments
...
class LRSchedulerFactory:
    ...
    def create(
        ...
        from xai_torch.core.training.sch.constants import LRSchedulerType
        ...
        if scheduler_args.name == LRSchedulerType.STEP_LR:  # tested
            ...
            from xai_torch.core.training.sch.schedulers import PolynomialLRDecay
            ...
            scheduler = PolynomialLRDecay(optimizer, max_decay_steps=max_decay_steps, **params)
        else:
...
class WdSchedulerFactory:
    ...
    def create(
        ...
        from xai_torch.core.training.sch.constants import WDSchedulerType
            ...
            for group in optimizer.param_groups:
                ...
                if group_name == target_group_name or target_group_name == "all" and initial_wd > 0:
                    if scheduler_args.name == WDSchedulerType.COSINE:
                        from xai_torch.core.training.sch.schedulers import CosineScheduler
