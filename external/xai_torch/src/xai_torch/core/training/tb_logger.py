...
from xai_torch.core.constants import MetricKeys
from xai_torch.core.training.constants import TrainingStage
from xai_torch.utilities.visualization import plot_confusion_matrix


class XAIOutputHandler(OutputHandler):
    def __init__(
        self,
        tag: str,
...
class XAITensorboardLogger(TensorboardLogger):
    def __init__(self, *args: Any, **kwargs: Any):
        super().__init__(*args, **kwargs)

    def _create_output_handler(self, *args: Any, **kwargs: Any) -> "OutputHandler":
        return XAIOutputHandler(*args, **kwargs)
