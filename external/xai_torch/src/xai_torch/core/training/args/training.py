...
from xai_torch.core.training.args.cutmix import CutmixupArguments
from xai_torch.core.training.args.early_stopping import EarlyStoppingArguments
from xai_torch.core.training.args.ema import ModelEmaArguments
from xai_torch.core.training.args.model_checkpoint import ModelCheckpointArguments
from xai_torch.core.training.optim.args import OptimizerArguments
from xai_torch.core.training.sch.args import LRSchedulerArguments, WDSchedulerArguments
...
class TrainingArguments:
    ...
    eval_every_n_epochs: Optional[int] = 1
